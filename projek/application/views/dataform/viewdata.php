					...
					<table class="table table-bordered table-striped" id="table1" style="width:100%">
						<thead>
							<tr>
								...
								<th style="text-align:center" width="120px">Subject</th>
								<th style="text-align:center" width="250px">Message</th>
						...
						<tbody>
							<?php $no =1;
								$datalaporan = $this->db->query("SELECT * FROM dataform");
								foreach ($datalaporan->result() as $l) { ?>
							<tr>
								<td style="text-align:center"><?php echo $no++ ?></td>
								<td style="text-align:center"><?php echo $l->nopeg ?></td>
								<td><?php echo $l->unit ?></td>
								<td style="text-align:center"><?php echo $l->subject ?></td>
								<td style="text-align:center"><?php echo $l->message ?></td>
								<td style="text-align:center"><?php echo $l->date ?></td>
								<!--  -->
							</tr>
							<?php }
							?>
